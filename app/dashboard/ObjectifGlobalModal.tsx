...
export default function ObjectifGlobalModal({
  userId,
  initialFeuilleId,
  initialRefExercice,
  initialNote,
  ...
  async function handleSave() {
    setLoading(true)
    await supabase.from('objectif_global').upsert(
      {
        user_id: userId,
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-base font-semibold text-gray-900">Objectif global</h2>
