-- Correction définitive : feuille_titre et obj_global_feuille_titre
-- utilisent désormais feuille_entrainement.titre (titre propre de la feuille)
-- au lieu de noeud.nom (nom du nœud parent / catégorie).
-- DROP obligatoire car la signature change (suppression des jointures noeud).
